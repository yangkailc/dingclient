...
//SendRobotTextMessageBySession can send a text message to a group chat by chat session
func (c *DingTalkClient) SendRobotTextMessageBySession(session string, msg string) (data MessageResponse, err error) {
        params := url.Values{}
        ...
        err = c.httpRPC("robot/sendBySession", params, request, &data)
        return data, err
}
